...
static const u8 sText_Lanettes[] = _("CLAR's"); //no decapitalize until it is everywhere
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNCANTUSEMOVERAGEBAITED]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} can't use {B_CURRENT_MOVE} after getting ragebaited!\p"),
    ...
    [STRINGID_PKMNCONTACTSHOCK]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was hurt by {B_DEF_NAME_WITH_PREFIX2}'s static!"),
    ...
    [STRINGID_ISREALLYANNOYING]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} is irritating EVERYONE!"),
    ...
    [STRINGID_ATAILWINDBLEW]                        = COMPOUND_STRING("A tailwind blew from behind {B_SCR_NAME_WITH_PREFIX}!"),
    ...
    [STRINGID_HEAVYARMORDOESNTALLOW]                = COMPOUND_STRING("The effects of the {B_LAST_ABILITY} prevent status moves from being used!\p"),
    ...
    [STRINGID_GLASSARMORSHATTER]                    = COMPOUND_STRING("The Glass Armor shattered into sharp spikes!"),
    [STRINGID_THESAURUSCHECK]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is checking its thesaurus!"),
    [STRINGID_PAINTBRUSHADDEDTYPE]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} painted on the {B_BUFF2} type!"),
    [STRINGID_PAINTBRUSHREPLACEDTYPE]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} painted over its {B_BUFF1} type with the {B_BUFF2} type!"),
    ...
    [STRINGID_TEMPORALASSERTIONENTERS]              = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} exerts control over all of time!"),
    ...
    [STRINGID_CORROSIVEODOR]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX2} expelled a corrosive odor!"),
    ...
    [STRINGID_ILEXWHIMSY         ]                  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s team became shrouded in a guarding mist!"),
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_TEMPORAL_ASSERTION] = STRINGID_TEMPORALASSERTIONENTERS,
};
