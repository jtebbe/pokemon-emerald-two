...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [POCKET_TRANSFORM_ITEMS] =        COMPOUND_STRING("TRANSFORM"),
...
const u8 gText_TransformItems[] = _("TRANSFORMS");
...
const u8 gText_StatEditor[] = _("EVs/IVs");
...
>>>>>>> 6faf35dde90f9fd46f15fd7baddadaaaad825f9b
