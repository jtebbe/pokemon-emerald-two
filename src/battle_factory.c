...
static const u16 sMoves_TotalPreparation[] =
{
    ...
    MOVE_TAILWIND, MOVE_ACUPRESSURE, MOVE_ROCK_POLISH, MOVE_NASTY_PLOT, MOVE_DEFEND_ORDER, MOVE_HONE_CLAWS,
    MOVE_AUTOTOMIZE, MOVE_QUIVER_DANCE, MOVE_COIL, MOVE_SHELL_SMASH, MOVE_SHIFT_GEAR, MOVE_WORK_UP,
    MOVE_COTTON_GUARD, MOVE_ROTOTILLER, MOVE_FLOWER_SHIELD, MOVE_AROMATIC_MIST, MOVE_GEOMANCY,
    MOVE_MAGNETIC_FLUX, MOVE_LASER_FOCUS, MOVE_GEAR_UP, MOVE_STUFF_CHEEKS, MOVE_NO_RETREAT,
    MOVE_CLANGOROUS_SOUL, MOVE_DECORATE, MOVE_COACHING, MOVE_VICTORY_DANCE, MOVE_SHELTER,
    MOVE_TAKE_HEART, MOVE_FILLET_AWAY, MOVE_TIDY_UP, MOVE_DRAGON_CHEER,
    MOVE_NONE
};
...
static const u16 sMoves_ImpossibleToPredict[] =
{
    ...
    MOVE_NATURAL_GIFT, MOVE_FLING, MOVE_PSYCHO_SHIFT, MOVE_POWER_TRICK, MOVE_ME_FIRST, MOVE_COPYCAT,
    MOVE_POWER_SWAP, MOVE_GUARD_SWAP, MOVE_WORRY_SEED, MOVE_HEART_SWAP, MOVE_SWITCHEROO, MOVE_JUDGMENT,
    MOVE_GUARD_SPLIT, MOVE_POWER_SPLIT, MOVE_RAGE_POWDER, MOVE_TELEKINESIS, MOVE_SOAK, MOVE_SIMPLE_BEAM,
    MOVE_ENTRAINMENT, MOVE_AFTER_YOU, MOVE_ALLY_SWITCH, MOVE_REFLECT_TYPE, MOVE_BESTOW, MOVE_TECHNO_BLAST,
    MOVE_RELIC_SONG, MOVE_TRICK_OR_TREAT, MOVE_FORESTS_CURSE, MOVE_TOPSY_TURVY, MOVE_ELECTRIFY,
    MOVE_SPOTLIGHT, MOVE_SPEED_SWAP, MOVE_POLLEN_PUFF, MOVE_REVELATION_DANCE, MOVE_INSTRUCT,
    MOVE_SPECTRAL_THIEF, MOVE_PHOTON_GEYSER, MOVE_MULTI_ATTACK, MOVE_MAGIC_POWDER, MOVE_TEATIME,
    MOVE_COURT_CHANGE, MOVE_SHELL_SIDE_ARM, MOVE_AURA_WHEEL, MOVE_POWER_SHIFT, MOVE_TERA_BLAST,
    MOVE_SPICY_EXTRACT, MOVE_DOODLE, MOVE_SHED_TAIL, MOVE_RAGING_BULL, MOVE_ORDER_UP, MOVE_IVY_CUDGEL,
    MOVE_TERA_STARSTORM, MOVE_FICKLE_BEAM,
    MOVE_NONE
};
...
static const u16 sMoves_WeakeningTheFoe[] =
{
    ...
    MOVE_MIRACLE_EYE, MOVE_EMBARGO, MOVE_HEAL_BLOCK, MOVE_GASTRO_ACID, MOVE_CAPTIVATE, MOVE_NOBLE_ROAR,
    MOVE_PARTING_SHOT, MOVE_PLAY_NICE, MOVE_CONFIDE, MOVE_EERIE_IMPULSE, MOVE_VENOM_DRENCH,
    MOVE_BABY_DOLL_EYES, MOVE_TEARFUL_LOOK, MOVE_TAR_SHOT, MOVE_CORROSIVE_GAS, MOVE_PSYCHIC_NOISE,
    MOVE_NONE
};
...
static const u16 sMoves_HighRiskHighReturn[] =
{
    ...
    MOVE_HAMMER_ARM, MOVE_HEALING_WISH, MOVE_METAL_BURST, MOVE_CLOSE_COMBAT, MOVE_LAST_RESORT,
    MOVE_SUCKER_PUNCH, MOVE_FLARE_BLITZ, MOVE_BRAVE_BIRD, MOVE_GIGA_IMPACT, MOVE_DRACO_METEOR,
    MOVE_LEAF_STORM, MOVE_ROCK_WRECKER, MOVE_WOOD_HAMMER, MOVE_HEAD_SMASH, MOVE_ROAR_OF_TIME,
    MOVE_LUNAR_DANCE, MOVE_FINAL_GAMBIT, MOVE_FREEZE_SHOCK, MOVE_ICE_BURN, MOVE_V_CREATE, MOVE_BELCH,
    MOVE_LIGHT_OF_RUIN, MOVE_DRAGON_ASCENT, MOVE_HYPERSPACE_FURY, MOVE_ICE_HAMMER, MOVE_BURN_UP,
    MOVE_SHELL_TRAP, MOVE_CLANGING_SCALES, MOVE_FLEUR_CANNON, MOVE_PRISMATIC_LASER, MOVE_MIND_BLOWN,
    MOVE_METEOR_ASSAULT, MOVE_ETERNABEAM, MOVE_STEEL_BEAM, MOVE_SCALE_SHOT, MOVE_METEOR_BEAM,
    MOVE_MISTY_EXPLOSION, MOVE_POLTERGEIST, MOVE_WAVE_CRASH, MOVE_CHLOROBLAST, MOVE_HEADLONG_RUSH,
    MOVE_AXE_KICK, MOVE_SPIN_OUT, MOVE_GLAIVE_RUSH, MOVE_MAKE_IT_RAIN, MOVE_ARMOR_CANNON,
    MOVE_DOUBLE_SHOCK, MOVE_GIGATON_HAMMER, MOVE_COMEUPPANCE, MOVE_BLOOD_MOON, MOVE_THUNDERCLAP,
    MOVE_SUPERCELL_SLAM, MOVE_UPPER_HAND,
    MOVE_NONE
};
...
static const u16 sMoves_Endurance[] =
{
    ...
    MOVE_ROOST, MOVE_LUCKY_CHANT, MOVE_AQUA_RING, MOVE_MAGNET_RISE, MOVE_DEFOG, MOVE_HEAL_ORDER,
    MOVE_WIDE_GUARD, MOVE_QUICK_GUARD, MOVE_HEAL_PULSE, MOVE_CLEAR_SMOG, MOVE_MAT_BLOCK,
    MOVE_CRAFTY_SHIELD, MOVE_KINGS_SHIELD, MOVE_SPIKY_SHIELD, MOVE_SHORE_UP, MOVE_BANEFUL_BUNKER,
    MOVE_FLORAL_HEALING, MOVE_STRENGTH_SAP, MOVE_PURIFY, MOVE_AURORA_VEIL, MOVE_GLITZY_GLOW,
    MOVE_BADDY_BAD, MOVE_FREEZY_FROST, MOVE_SPARKLY_SWIRL, MOVE_LIFE_DEW, MOVE_OBSTRUCT,
    MOVE_JUNGLE_HEALING, MOVE_LUNAR_BLESSING, MOVE_SILK_TRAP, MOVE_REVIVAL_BLESSING, MOVE_BURNING_BULWARK,
    MOVE_NONE
};
...
static const u16 sMoves_SlowAndSteady[] =
{
    ...
    MOVE_TOXIC_SPIKES, MOVE_STEALTH_ROCK, MOVE_DARK_VOID, MOVE_QUASH, MOVE_STICKY_WEB, MOVE_FAIRY_LOCK,
    MOVE_POWDER, MOVE_NUZZLE, MOVE_TOXIC_THREAD, MOVE_BUZZY_BUZZ, MOVE_SIZZLY_SLIDE, MOVE_SAPPY_SEED,
    MOVE_OCTOLOCK, MOVE_STONE_AXE, MOVE_CEASELESS_EDGE, MOVE_SALT_CURE, MOVE_MORTAL_SPIN, MOVE_SYRUP_BOMB,
    MOVE_NONE
};
...
static const u16 sMoves_DependsOnTheBattlesFlow[] =
{
    ...
    MOVE_GRAVITY, MOVE_TRICK_ROOM, MOVE_WONDER_ROOM, MOVE_MAGIC_ROOM, MOVE_ION_DELUGE, MOVE_GRASSY_TERRAIN,
    MOVE_MISTY_TERRAIN, MOVE_ELECTRIC_TERRAIN, MOVE_SOLAR_BLADE, MOVE_PSYCHIC_TERRAIN,
    MOVE_EXPANDING_FORCE, MOVE_STEEL_ROLLER, MOVE_GRASSY_GLIDE, MOVE_RISING_VOLTAGE, MOVE_TERRAIN_PULSE,
    MOVE_CHILLY_RECEPTION, MOVE_SNOWSCAPE, MOVE_PSYBLADE, MOVE_HYDRO_STEAM, MOVE_ELECTRO_SHOT,
    MOVE_NONE
};
