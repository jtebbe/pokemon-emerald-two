...
static void PlayerNotOnBikeMoving(u8 direction, u16 heldKeys)
{
    ...
    if (!(gPlayerAvatar.flags & PLAYER_AVATAR_FLAG_UNDERWATER) && !((heldKeys & B_BUTTON) && FlagGet(FLAG_ALWAYS_RUN)) && ((heldKeys & B_BUTTON) || FlagGet(FLAG_ALWAYS_RUN)) && FlagGet(FLAG_SYS_B_DASH)
