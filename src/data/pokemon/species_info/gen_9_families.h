...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_PAWMO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 29, SPECIES_PAWMOT}),
    },
    ...
    [SPECIES_SHROODLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_GRAFAIAI}),
    },
    ...
    [SPECIES_SCOVILLAIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_MOODY, ABILITY_TWINCAST },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_BOMBIRDIER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_RATTLED, ABILITY_KEEN_EYE, ABILITY_ROCKY_PAYLOAD },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_VELUZA] =
    {
        ...
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_SHARP_SCALES, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_GRAY,
