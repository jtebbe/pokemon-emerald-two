...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_UNBURDEN, ABILITY_SWIFT_SLICES },
    ...
    [SPECIES_ZIGZAGOON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PICKUP, ABILITY_FUR_COAT, ABILITY_QUICK_FEET },
    #else
    ...
    [SPECIES_LINOONE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_GLUTTONY, ABILITY_FUR_COAT, ABILITY_QUICK_FEET },
    #else
        .abilities = { ABILITY_PICKUP, ABILITY_NONE, ABILITY_QUICK_FEET },
    #endif
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_MULTISCALE, ABILITY_SIMPLE },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_LOUDRED] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_EXPLOUD}),
    },
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STURDY, ABILITY_STOUT_SHIELD, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_PROBOPASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STURDY, ABILITY_STOUT_SHIELD, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_GULPIN] =
    {
        ...
        .abilities = { ABILITY_LIQUID_OOZE, ABILITY_STICKY_HOLD, ABILITY_OBLIVIOUS },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PRANKSTER, ABILITY_CONTRARY, ABILITY_RAGEBAITER },
    #else
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LEVITATE, ABILITY_RATTLED, ABILITY_GRAVITATION },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SOLROCK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LEVITATE, ABILITY_OBLIVIOUS, ABILITY_GRAVITATION },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_CLAYDOL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_TELEPATHY, ABILITY_GRAVITATION },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_SHUPPET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_DEFIANT, ABILITY_FRISK },
    #else
    ...
    [SPECIES_DUSKNOIR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_PRESSURE, ABILITY_SOUL_STRIKES, ABILITY_FRISK },
    #else
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_ATONAL_BELLS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CHIMECHO_MEGA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_ECHOING_CHIMES, ABILITY_ECHOING_CHIMES, ABILITY_ECHOING_CHIMES },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Chimecho"),
        .cryId = CRY_CHIMECHO,
        .natDexNum = NATIONAL_DEX_CHIMECHO,
    ...
    [SPECIES_ABSOL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_UNNERVE, ABILITY_SUPER_LUCK, ABILITY_DEFIANT },
    #else
    ...
    [SPECIES_GOREBYSS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_CLEAR_BODY, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_REGIROCK] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_STURDY, ABILITY_ARCHAIC_SHARDS },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_REGICE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_ICE_BODY, ABILITY_ABSOLUTE_ZERO },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_REGISTEEL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_HEAVY_METAL, ABILITY_METALLICIZE },
        .bodyColor = BODY_COLOR_GRAY,
