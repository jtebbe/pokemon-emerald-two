...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_SHELL_ARMOR, ABILITY_STAMINA },
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_QUEENLY_MAJESTY, ABILITY_COMPETITIVE },
    #else
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_CONCERTMASTER, ABILITY_RUN_AWAY },
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_CONCERTMASTER, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SHINX] =
    {
        ...
        .abilities = { ABILITY_INFILTRATOR, ABILITY_INTIMIDATE, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shinx"),
        .cryId = CRY_SHINX,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_STURDY, ABILITY_STOUT_SHIELD, ABILITY_SOUNDPROOF },
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .abilities = { ABILITY_PRANKSTER, ABILITY_INNER_FOCUS, ABILITY_MARTIAL_EXPERT },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Riolu"),
        .cryId = CRY_RIOLU,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_JUSTIFIED, ABILITY_INNER_FOCUS, ABILITY_MARTIAL_EXPERT },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_DRY_SKIN, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DIALGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_TELEPATHY, ABILITY_LORD_OF_TIME },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_DIALGA_ORIGIN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_TELEPATHY, ABILITY_TEMPORAL_ASSERTION },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Dialga"),
        .cryId = CRY_DIALGA,
        .natDexNum = NATIONAL_DEX_DIALGA,
    ...
    [SPECIES_PALKIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_TELEPATHY, ABILITY_LORD_OF_SPACE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_PALKIA_ORIGIN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_TELEPATHY, ABILITY_SPACIAL_DOMINANCE },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Palkia"),
        .cryId = CRY_PALKIA,
        .natDexNum = NATIONAL_DEX_PALKIA,
    ...
    [SPECIES_HEATRAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_NONE, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_GIRATINA_ALTERED] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_TELEPATHY, ABILITY_UMBRAL_GRIP },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_GIRATINA_ORIGIN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_LEVITATE, ABILITY_DISTORTION },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Giratina"),
        .cryId = CRY_GIRATINA,
        .natDexNum = NATIONAL_DEX_GIRATINA,
...
#define ARCEUS_SPECIES_INFO(type, typeName, iconPal)                                \
    {                                                                               \
        ...
        .growthRate = GROWTH_SLOW,                                                  \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),                  \
        .abilities = { ABILITY_MULTITYPE, ABILITY_NONE, ABILITY_OMNIPOTENCE },      \
        .bodyColor = BODY_COLOR_WHITE,                                              \
