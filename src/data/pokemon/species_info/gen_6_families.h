...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_PSYRIDER, ABILITY_MAGIC_SHOW },
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RIVALRY, ABILITY_UNNERVE, ABILITY_TRIUMPHANCE },
        .bodyColor = BODY_COLOR_BROWN,
...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                  \
        ...
        .abilities = { ABILITY_FLOWER_VEIL, ABILITY_LINGERING_AROMA, ABILITY_SYMBIOSIS },  \
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_MALAMAR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
        .abilities = { ABILITY_CONTRARIAN, ABILITY_CONTRARIAN, ABILITY_CONTRARIAN },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Malamar"),
        .cryId = CRY_MALAMAR,
        .natDexNum = NATIONAL_DEX_MALAMAR,
    ...
    [SPECIES_BINACLE] =
    {
        ...
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_TWINCAST, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_BARBARACLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_STURDY, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .abilities = { ABILITY_POISON_POINT, ABILITY_STALWART, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .abilities = { ABILITY_CHEEK_POUCH, ABILITY_PLUS, ABILITY_CONTACT_SHOCK },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CARBINK] =
    {
        ...
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_DAZZLING, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .abilities = { ABILITY_WANDERING_SPIRIT, ABILITY_FRISK, ABILITY_HALLOWS_END },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PUMPKABOO_SMALL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_PICKUP, ABILITY_WANDERING_SPIRIT, ABILITY_HALLOWS_END },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Pumpkaboo"),
        .cryId = CRY_PUMPKABOO,
        .natDexNum = NATIONAL_DEX_PUMPKABOO,
    ...
    [SPECIES_HOOPA_CONFINED] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MAGICIAN, ABILITY_NONE, ABILITY_MAGIC_SHOW },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Hoopa"),
    ...
    [SPECIES_HOOPA_UNBOUND] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_NONE, ABILITY_MAGIC_SHOW },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Hoopa"),
