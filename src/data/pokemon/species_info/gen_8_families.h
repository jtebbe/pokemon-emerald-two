...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_SCORBUNNY] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_DEFIANT, ABILITY_LIBERO },
    ...
    [SPECIES_SOBBLE] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_SNIPER, ABILITY_GOLDEN_EYES},
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_ETERNATUS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_POWER_HOARD },
        .bodyColor = BODY_COLOR_PURPLE,
