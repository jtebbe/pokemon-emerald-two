...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_BLAZING_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING("May burn foe."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_WICKED_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING("May sleep foe."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_NOXIOUS_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING("May poison foe."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_POISON,
        .accuracy = 100,
    ...
    [MOVE_COMBAT_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING("May paralyze foe."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_MAGICAL_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING("May confuse foe."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FAIRY,
        .accuracy = 100,
    ...
    [MOVE_FRIGID_TOUCH] =
    {
        .name = COMPOUND_STRING("Frigid Touch"),
        .description = COMPOUND_STRING(
            "A cold touch that\n"
            "causes frostbite."),
        .effect = EFFECT_NON_VOLATILE_STATUS,
        ...
        .category = DAMAGE_CATEGORY_STATUS,
        .magicCoatAffected = TRUE,
        .battleAnimScript = gBattleAnimMove_FrigidTouch,
    },

    [MOVE_BOREAL_BLAST] =
    {
        .name = COMPOUND_STRING("Boreal Blast"),
        .description = COMPOUND_STRING(
            "A blast of ice that\n"
        ...
        .battleAnimScript = gBattleAnimMove_BorealBlast,
    },
    ...
    [MOVE_HIT_AND_RUN] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .battleAnimScript = gBattleAnimMove_HitAndRun,
    },

    [MOVE_CAUSTIC_SPIT] =
    {
        .name = COMPOUND_STRING("Caustic Spit"),
        .description = COMPOUND_STRING(
            "A fast, acidic spit\n"
            "that badly poisons."),
        .effect = EFFECT_HIT,
        ...
        .battleAnimScript = gBattleAnimMove_CausticSpit,
    },

    [MOVE_GALE_TAIL] =
    {
        .name = COMPOUND_STRING("Gale Tail"),
        .description = COMPOUND_STRING(
            "A tail slap that\n"
            "lowers foe's speed."),
        .effect = EFFECT_HIT,
        ...
        .battleAnimScript = gBattleAnimMove_GaleTail,
    },

    [MOVE_HEROIC_RISE] =
    {
        .name = COMPOUND_STRING("Heroic Rise"),
        .description = COMPOUND_STRING(
            "Raises all of the user's\n"
            "stats but prevents escape."),
        .effect = EFFECT_NO_RETREAT,
        ...
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
        .battleAnimScript = gBattleAnimMove_HeroicRise,
    },
    ...
    [MOVE_SCORPION_STRIKE] =
    {
        .name = COMPOUND_STRING("Scorpion Strike"),
        .description = COMPOUND_STRING(
            "A corrosive sting\n"
            "that badly poisons."),
        .effect = EFFECT_HIT,
        ...
        .battleAnimScript = gBattleAnimMove_ScorpionStrike,
    },

    [MOVE_DRACONIC_STRIKE] =
    {
        .name = COMPOUND_STRING("Draconic Strike"),
        .description = COMPOUND_STRING(
            "A fast dragon claw\n"
            "that hits first."),
        .effect = EFFECT_HIT,
        ...
        .priority = 2,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .battleAnimScript = gBattleAnimMove_DraconicStrike,
    },

    [MOVE_VERDANT_ARROW] =
    {
        .name = COMPOUND_STRING("Verdant Arrow"),
        .description = COMPOUND_STRING(
            "A swift arrow\n"
            "that strikes first."),
        .effect = EFFECT_HIT,
        ...
        .priority = 1,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .battleAnimScript = gBattleAnimMove_VerdantArrow,
    },

    [MOVE_SWIFT_CHOMP] =
    {
        .name = COMPOUND_STRING("Swift Chomp"),
        .description = COMPOUND_STRING(
            "A quick bite that\n"
            "strikes first."),
        .effect = EFFECT_HIT,
        ...
        .bitingMove = TRUE,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .battleAnimScript = gBattleAnimMove_SwiftChomp,
    },

    [MOVE_DEADLY_KISS] =
    {
        .name = COMPOUND_STRING("Deadly Kiss"),
        .description = COMPOUND_STRING(
            "The user imparts a\n"
            "toxic kiss and leaves."),
        .effect = EFFECT_DEADLY_KISS,
        .power = 0,
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = 5,
    ...
    [MOVE_BLAZING_WHIP] =
    {
        .name = COMPOUND_STRING("Blazing Whip"),
        .description = COMPOUND_STRING(
            "The user lashes with\n"
            "a flaming tail."),
        .effect = EFFECT_HIT,
        .power = 95,
        .type = TYPE_FIRE,
        ...
        .battleAnimScript = gBattleAnimMove_BlazingWhip,
    },
    ...
    [MOVE_STONE_STRIKE] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user slams with stones.\n"
            "May lower foe defense."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_ROCK,
        .accuracy = 100,
    ...
    [MOVE_SALSA_SHAKES] =
    {
        .name = COMPOUND_STRING("Salsa Shakes"),
        .description = COMPOUND_STRING(
            "A mystical dance that ups\n"
            "Ally attacking stats."),
        .effect = EFFECT_ALLY_ATTACKS_UP,
        .power = 0,
        .type = TYPE_GRASS,
        .accuracy = 0,
        .pp = 20,
