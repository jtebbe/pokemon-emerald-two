...
const u32 gObjectEventPic_BattleItemBall[] = INCBIN_U32("graphics/object_events/pics/misc/ball_battle_item.4bpp");
const u32 gObjectEventPic_MegaStoneBall[] = INCBIN_U32("graphics/object_events/pics/misc/ball_mega_stone.4bpp");
