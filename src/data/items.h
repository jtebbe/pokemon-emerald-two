...
// Misc. Held Items
    ...
    [ITEM_BURGLARY_KIT] =
    {
        .name = ITEM_NAME("Burglary Kit"),
        .price = 0,
        .holdEffect = HOLD_EFFECT_BURGLARY_KIT,
        .description = COMPOUND_STRING(
            "Holder can attack\n"
            "through protect\n"
            "and substitute."),
