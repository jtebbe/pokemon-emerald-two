...
static void TextSpeed_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_TextSpeedSlow, 82, YPOS_TEXTSPEED, styles[0]);
    DrawOptionMenuChoice(gText_TextSpeedMid, 118, YPOS_TEXTSPEED, styles[1]);
    DrawOptionMenuChoice(gText_TextSpeedFast, 150, YPOS_TEXTSPEED, styles[2]);
    DrawOptionMenuChoice(gText_TextSpeedInstant, 187, YPOS_TEXTSPEED, styles[3]);
}
