...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_DRILBUR_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_FOREST_GROTTO] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DEN_GROTTO] = MAPPOPUP_THEME_STONE,
    [MAPSEC_CALDERA_GROTTO] = MAPPOPUP_THEME_STONE,
    [MAPSEC_CASCADE_GROTTO] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MEADOW_GROTTO] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AGARTHA] = MAPPOPUP_THEME_STONE,
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_AGARTHA] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_DRILBUR_CAVE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FOREST_GROTTO] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_DEN_GROTTO] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CALDERA_GROTTO] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CASCADE_GROTTO] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MEADOW_GROTTO] = MAPPOPUP_THEME_BW_DEFAULT,
