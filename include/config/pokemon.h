...
#define P_VAR_MOVE_RELEARNER_STATE       VAR_MOVE_RELEARNER      // IMPORTANT! Assign a var to make the move relearner swap between level up, egg, TM and tutor.
...
#define P_FLAG_SCRIPT_MOVE_RELEARNER     FLAG_MOVE_RELEARNER      // Set this flag if you're planning on using the move relearner script from data/scripts/move_relearner.inc
