...
#define B_FLAG_TERA_ORB_NO_COST     FLAG_UNUSED_0x265     // If this flag is set, the Tera Orb does not use up its charge upon Terastallization. In S/V, this occurs after an event with Terapagos.
