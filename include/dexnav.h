...
enum RowGUIInfo
{
    ROW_WATER,
    ROW_LAND_TOP,
    ROW_LAND_UPPER_MIDDLE,
    ROW_LAND_LOWER_MIDDLE,
    ROW_LAND_BOT,
    ROW_HIDDEN,
    ROWS_COUNT
};
...
#define ROW_LAND_UPPER_MID_ICON_Y (ROW_LAND_TOP_ICON_Y + 24)
#define ROW_LAND_LOWER_MID_ICON_Y (ROW_LAND_UPPER_MID_ICON_Y + 24)
#define ROW_LAND_BOT_ICON_Y     (ROW_LAND_LOWER_MID_ICON_Y + 24)
