...
extern const u8 Battlescript_CorrosiveOdorActivates[];
...
extern const u8 BattleScript_AllStatsUpDouble[];
...
extern const u8 BattleScript_SelectingNotAllowedMoveRagebaiter[];
extern const u8 BattleScript_MoveUsedIsRagebaited[];
extern const u8 BattleScript_SelectingNotAllowedMoveRagebaiterInPalace[];
...
extern const u8 BattleScript_ThesaurusSetUp[];
...
extern const u8 BattleScript_RagebaiterActivates[];
extern const u8 BattleScript_MagicWindsActivates[];
...
extern const u8 BattleScript_AbilityContactShock[];
...
extern const u8 BattleScript_SelectingNotAllowedMoveHeavyArmor[];
extern const u8 BattleScript_SelectingNotAllowedMoveHeavyArmorInPalace[];
...
extern const u8 BattleScript_PaintbrushAddsType[];
extern const u8 BattleScript_PaintbrushReplacesType[];
extern const u8 BattleScript_StormdancerActivates[];
...
extern const u8 BattleScript_MagicShowActivates[];
extern const u8 BattleScript_GravitationActivates[];
extern const u8 BattleScript_IlexWhimsyActivates[];
...
extern const u8 BattleScript_GlassArmorShatters[];
...
extern const u8 BattleScript_SharpScalesActivates[];
extern const u8 BattleScript_PrimordialShardsActivates[];
extern const u8 BattleScript_OverwhelmActivates[];
...
extern const u8 BattleScript_StrangeSwordHeldRet[];
extern const u8 BattleScript_StrangeShieldHeldRet[];
extern const u8 BattleScript_BurglaryKitMsgIn[];
extern const u8 BattleScript_BurglaryKitMsgInRet[];
