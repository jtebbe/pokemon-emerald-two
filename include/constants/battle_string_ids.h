...
enum StringID
{
    ...
    STRINGID_PKMNCANTUSEMOVERAGEBAITED,
    ...
    STRINGID_HEAVYARMORDOESNTALLOW,
    ...
    STRINGID_GLASSARMORSHATTER,
    STRINGID_THESAURUSCHECK,
    STRINGID_PAINTBRUSHADDEDTYPE,
    STRINGID_PAINTBRUSHREPLACEDTYPE,
    ...
    STRINGID_HALLOWSENDENTERS,
    STRINGID_TEMPORALASSERTIONENTERS,
    STRINGID_HALLOWSENDOVER,
    ...
    STRINGID_STRANGESWORDHELD,
    STRINGID_STRANGESHIELDHELD,
    STRINGID_LORDOFTIME,
    STRINGID_SPACIALDOMINANCE,
    STRINGID_ABILITYSHIELDPROTECTS,
    STRINGID_BURGLARYKIT,
    STRINGID_COUNT
};
...
enum SwitchInAbilityStringID
{
    ...
    B_MSG_SWITCHIN_SPACIALDOMINANCE,
    B_MSG_SWITCHIN_HALLOWS_END,
    B_MSG_SWITCHIN_TEMPORAL_ASSERTION,
};
