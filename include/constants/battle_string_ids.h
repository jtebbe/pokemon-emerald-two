...
#define STRINGID_PKMNISALREADYFROSTBITTEN             730
#define STRINGID_PKMNCUTSSPATTACKWITH                 731
#define STRINGID_STRANGESWORDHELD                     732
#define STRINGID_STRANGESHIELDHELD                    733
