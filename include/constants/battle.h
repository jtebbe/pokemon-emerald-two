...
#define BATTLE_TYPE_HAS_AI          (BATTLE_TYPE_TRAINER | BATTLE_TYPE_FIRST_BATTLE | BATTLE_TYPE_SAFARI | BATTLE_TYPE_ROAMER | BATTLE_TYPE_INGAME_PARTNER | BATTLE_TYPE_FRONTIER)
...
#define SIDE_STATUS_OTHERS         (SIDE_STATUS_TAILWIND | SIDE_STATUS_SAFEGUARD | SIDE_STATUS_MIST | SIDE_STATUS_LUCKY_CHANT)
...
// Constants for One-Two
#define ONE_TWO_1ST_HIT 2
#define ONE_TWO_2ND_HIT 1
#define ONE_TWO_OFF 0
