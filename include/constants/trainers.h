...
#define TRAINER_PIC_AGARTHAN_JESTER       93
#define TRAINER_PIC_AGARTHAN_SLAYER       94
#define TRAINER_PIC_CLARK                 95
#define TRAINER_PIC_AGARTHAN_SCOUT        96
#define TRAINER_PIC_AGARTHAN_OCCULTIST    97
#define TRAINER_PIC_AGARTHAN_KING         98
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_OCCULTIST,
    TRAINER_CLASS_KING,
    TRAINER_CLASS_SCRIBE,
    TRAINER_CLASS_SLAYER,
    TRAINER_CLASS_JESTER,
    TRAINER_CLASS_DOCTOR,
    TRAINER_CLASS_AGARTHAN_PSYCHIC,
    TRAINER_CLASS_SCOUT,
    TRAINER_CLASS_SAGE,
    TRAINER_CLASS_COUNT,
};
