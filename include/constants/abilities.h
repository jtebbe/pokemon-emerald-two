...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_ONE_TWO = 311,
    ABILITY_HYPNOTIST = 312,
    ABILITY_ALGAE_ADDICT = 313,
    ABILITY_PHONETIC_MAGIC = 314,
    ABILITY_ATONAL_BELLS = 315,
    ABILITY_ABSOLUTE_ZERO = 316,
    ABILITY_ARCHAIC_SHARDS = 317,
    ABILITY_METALLICIZE = 318,
    ABILITY_CONCERTMASTER = 319,
    ABILITY_TRIUMPHANCE = 320,
    ABILITY_RANGER = 321,
    ABILITY_MAGIC_SHOW = 322,
    ABILITY_GRAVITATION = 323,
    ABILITY_SNOW_BLOW = 324,
    ABILITY_SOUL_STRIKES = 325,
    ABILITY_STOUT_SHIELD = 326,
    ABILITY_LORD_OF_TIME = 327,
    ABILITY_LORD_OF_SPACE = 328,
    ABILITY_SPACIAL_DOMINANCE = 329,
    ABILITY_TEMPORAL_ASSERTION = 330,
    ABILITY_DISTORTION = 331,
    ABILITY_UMBRAL_GRIP = 332,
    ABILITY_ILEX_WHIMSY = 333,
    ABILITY_RAGEBAITER = 334,
    ABILITY_HALLOWS_END = 335,
    ABILITY_POWER_HOARD = 336,
    ABILITY_OVERWHELM = 337,
    ABILITY_MIND_ETERNAL = 338,
    ABILITY_HEART_ETERNAL = 339,
    ABILITY_BODY_ETERNAL = 340,
    ABILITY_SHOCKING_AMALGAM = 341,
    ABILITY_BLAZING_AMALGAM = 342,
    ABILITY_OMNIPOTENCE = 343,
    ABILITY_CORROSIVE_ODOR = 344,
    ABILITY_TEN_STEPS_AHEAD = 345,
    ABILITY_SHARP_SCALES = 346,
    ABILITY_TWINCAST = 347,
    ABILITY_SANDSWORN = 348,
    ABILITY_HEAVY_ARMOR = 349,
    ABILITY_SWIFT_SLICES = 350,
    ABILITY_PSYRIDER = 351,
    ABILITY_GOLDEN_EYES = 352,
    ABILITY_STICK_HOARDER = 353,
    ABILITY_MARTIAL_EXPERT = 354,
    ABILITY_COVETOUS = 355,
    ABILITY_STORMDANCER = 356,
    ABILITY_CONTACT_SHOCK = 357,
    ABILITY_MEGA_SOL = 358,
    ABILITY_DRAGONIZE = 359,
    ABILITY_SPICY_SPRAY = 360,
    ABILITY_PIERCING_DRILL = 361,
    ABILITY_STORMBREAKER = 362,
    ABILITY_CHLOROTOXIN = 363,
    ABILITY_MAGIC_WINDS = 364,
    ABILITY_ECHOING_CHIMES = 365,
    ABILITY_CONTRARIAN = 366,
